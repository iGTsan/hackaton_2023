...
-- Table: criterion_1
CREATE TABLE IF NOT EXISTS criterion_1 (user_id INTEGER PRIMARY KEY UNIQUE, grade_1 INTEGER DEFAULT (0), grade_2 INTEGER DEFAULT (0));
...
-- Table: users
CREATE TABLE IF NOT EXISTS users (user_id INTEGER PRIMARY KEY UNIQUE);
